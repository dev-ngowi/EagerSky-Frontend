<template>
  <VaNavbar class="web-layout-navbar py-2 px-0" style="background-color: #0a2540; color: #ffffff">
    <template #left>
      <div class="left">
    ...
    <template #right>
      <AppNavbarActions class="web-navbar__actions" :is-mobile="isMobile" />
    </template>
  </VaNavbar>
</template>
...
import AppNavbarActions from './component/WebNavbarActions.vue';
