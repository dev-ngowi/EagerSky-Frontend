<template>
  <div class="p-4">
    <h2 class="text-xl font-bold mb-4">{{ $t('Edit Document Category') }}</h2>
...
import { FormData, Errors, Payload, DocumentCategory } from '../../../../types/documentCategory'
...
export default defineComponent({
  ...
  props: {
    documentCategory: {
      type: Object as () => DocumentCategory,
      required: true,
    },
  },
  emits: ['submit', 'close'],
