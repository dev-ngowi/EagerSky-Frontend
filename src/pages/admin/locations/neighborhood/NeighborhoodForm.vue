<template>
  <div class="p-4">
    <h2 class="text-xl font-bold mb-4">{{ $t('neighborhood.add_new') }}</h2>
...
import { FormData, Errors, Payload, GroupedOptions } from '../../../../types/neighborhood';
...
export default defineComponent({
  ...
  methods: {
    ...
    async submitForm() {
      ...
      if (!this.form.last_updated) this.errors.last_updated = 'Last updated date is required';
