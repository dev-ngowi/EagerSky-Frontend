...
export const adminRoutes: RouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        meta: { requiresAuth: true, title: 'Maintenance Requests', icon: 'report_problem', roles: ['admin'] },
      },
      {
        name: 'contractors',
        path: 'contractors',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: 'Admin Settings', icon: 'settings', roles: ['admin'] },
  },
];